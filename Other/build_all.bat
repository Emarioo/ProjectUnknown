...
SET e_defines=/DENGONE_PHYSICS /DENGONE_LOGGER /DENGONE_TRACKER /DENGONE_OPENGL /D!PLATFORM! /DGLEW_STATIC
SET p_defines=/DENGONE_PHYSICS /DENGONE_LOGGER /DENGONE_TRACKER /DENGONE_OPENGL /DGLEW_STATIC /D!PLATFORM!
@REM SET g_defines=/DENGONE_PHYSICS /DENGONE_LOGGER /DENGONE_TRACKER /DENGONE_OPENGL /D!PLATFORM! /DGLEW_BUILD /DGLFW_DLL
SET g_defines=/DENGONE_PHYSICS /DENGONE_LOGGER /DENGONE_TRACKER /DENGONE_OPENGL /D!PLATFORM! /DGLEW_STATIC
