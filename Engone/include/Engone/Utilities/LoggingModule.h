...
/* Error/log system
	...
	The commented section below the GUARD exists in the .cpp file. I have decided to not use IMPL like things
	because the code is nested within ifdef which is annoying.
*/
