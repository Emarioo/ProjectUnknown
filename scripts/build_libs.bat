...
SET r_defines=
@REM SET w_defines=/D_WIN32 /DGLEW_STATIC /DWIN32_LEAN_AND_MEAN
SET w_defines=/D_WIN32 /DGLEW_BUILD /DWIN32_LEAN_AND_MEAN
@REM SET f_defines=/D_GLFW_BUILD_WIN32 /D_GLFW_WIN32 /D_GLFW_BUILD_DLL /D_WIN32 /D_GLFW_WGL /D_GLFW_USE_OPENGL
SET f_defines=/D_GLFW_USE_CONFIG_H
@REM SET f_defines=/DGLFW_BUILD_WIN32 /D_GLFW_WIN32 /D_WIN32 /D_GLFW_WGL /D_GLFW_USE_OPENGL
...
SET C_COMPILE_OPTIONS=/std:c11 /MDd /nologo /TC
...
@REM lib %objdir%\all_glew.o !libdirs! !w_libs! !libopts! /OUT:bin/Debug-MSVC/glew.lib
@REM lib %objdir%\all_glfw3.o !libdirs! !f_libs! !libopts! /OUT:bin/Debug-MSVC/glfw3.lib

link %objdir%\all_glew.o !libdirs! !w_libs! !LINK_OPTIONS! /DLL /OUT:bin/Debug-MSVC/glew.dll
link %objdir%\all_glfw3.o !libdirs! !f_libs! !LINK_OPTIONS! /DLL /OUT:bin/Debug-MSVC/glfw3.dll
